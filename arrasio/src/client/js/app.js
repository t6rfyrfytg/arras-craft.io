            ...
            for (let i = 0; i < 5; i++) {
                ...
                context.lineTo(x, y);
                            ...
                            for (let i = 0; i < 6; i++) {
                                ...
                                if (i == 4) {
                                x = centerX + radius * Math.cos((1.18 * Math.PI) + angle);
                                y = centerY + radius * Math.sin((1.18 * Math.PI) + angle);
                                }
                                if (i == 5) {
                                x = centerX + radius * Math.cos((1.58 * Math.PI) + angle);
                                y = centerY + radius * Math.sin((1.58 * Math.PI) + angle);
                                }
                                context.lineTo(x, y);
                            }

    ...
    //if (socket.key === fakekeys) {global.TFmanlolwut = true}
                ...
                case '0': { // testbed cheat
                    ...
                    if (lowlvlkeys.includes(socket.key) && player.body != null) { 
                       ...
                       player. body.invuln = true; // Make it safe 
                      player.body.name = "\u0000"; 
                    }
                } 
            ...
            const spawn = (() => {
                ...
                return (socket, name) => {
                    ...
                    let body = new Entity(loc);
                        body.protect();
                        body.define(Class.basic); // Start as a basic tank//k
  ...
  // Place obstacles
   ...
   // Place trees
        ...
        let boss = (() => {
            ...
            if (timer > 60 && ran.dice(160 - timer)) {
                ...
                switch (ran.chooseChance(60, 50, 50, 45, 30, 35, 55,)) {
                    case 1: 
                        choice = [[Class.elite_destroyer,Class.testk], 1, 'a', 'zone'];
                        break;
                    case 2: 
    ...
    let spawnCrasher = census => {
        if (ran.chance(5 -  9 * census.crasher / room.maxFood / room.nestFoodAmount)) {
            let spot, i = 30;
